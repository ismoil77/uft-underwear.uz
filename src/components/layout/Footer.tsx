    ...
    <footer className="bg-secondary text-text-inverse">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Navigation */}
          <div>
            <h3 className="text-lg font-bold mb-4">{tNav('catalog')}</h3>
          ...
          <div>
            ...
            <div className="flex gap-3">
              {contacts.socials?.telegram && (
                ...
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.99-.65-.35-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69.01-.03.01-.14-.07-.2-.08-.06-.19-.04-.27-.02-.12.02-1.96 1.25-5.54 3.67-.52.36-1 .53-1.42.52-.47-.01-1.37-.26-2.03-.48-.82-.27-1.47-.42-1.42-.88.03-.24.37-.49 1.02-.75 4.01-1.74 6.69-2.89 8.03-3.45 3.83-1.6 4.63-1.87 5.15-1.88.11 0 .37.03.54.18.14.12.18.29.2.45-.01.06.01.24 0 .38z"/>
                  </svg>
                </a>
              )}
              ...
              {contacts.socials?.instagram && (
                <a
                  href={`https://instagram.com/${contacts.socials.instagram.replace('@', '')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center bg-white/10 rounded-lg hover:bg-white/20 transition-colors"
                >
